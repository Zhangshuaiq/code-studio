...
export class K8sController {
  ...
  @RequirePermissions(
    PERMISSIONS.DEPLOY_TARGET_MANAGE,
    PERMISSIONS.NAMESPACE_MANAGE,
  )
  ...
  async scaleDeployment(
    ...
    return this.k8s.scaleDeployment(
      targetId,
      user.id,
      namespace,
      name,
  ...
  @Delete(":targetId/namespaces/:namespace/services/:name")
  @RequirePermissions(
    PERMISSIONS.DEPLOY_TARGET_MANAGE,
    PERMISSIONS.NAMESPACE_MANAGE,
  )
  @Audit("k8s.service.delete", "service")
  deleteService(
    @Param("targetId") targetId: string,
    @Param("namespace") namespace: string,
    @Param("name") name: string,
    ...
    return this.k8s.deleteService(targetId, user.id, namespace, name);
  }

  @Delete(":targetId/namespaces/:namespace/ingresses/:name")
  @RequirePermissions(
    PERMISSIONS.DEPLOY_TARGET_MANAGE,
    PERMISSIONS.NAMESPACE_MANAGE,
  )
  @Audit("k8s.ingress.delete", "ingress")
  deleteIngress(
    @Param("targetId") targetId: string,
    @Param("namespace") namespace: string,
    @Param("name") name: string,
    ...
    return this.k8s.deleteIngress(targetId, user.id, namespace, name);
  }
}
