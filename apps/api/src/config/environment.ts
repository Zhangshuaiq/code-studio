...
const integerRules: Record<string, { min: number; max: number }> = {
  ...
  AGENT_MAX_WORKSPACE_GROWTH_FILES: { min: 1, max: 1_000_000 },
  AGENT_MAX_WORKSPACE_GROWTH_BYTES: { min: 1_048_576, max: 1_099_511_627_776 },
  AGENT_MIN_FREE_DISK_BYTES: { min: 1_048_576, max: 1_099_511_627_776 },
